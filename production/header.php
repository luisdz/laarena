        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="../prepago/principal.php" class="site_title"><i class="fa fa-tachometer"></i> <span>La Arena</span></a>
            </div>
            ...
            <div class="profile">
              <div class="profile_pic">
                <img src="../images/logo_arena.jpg" alt="..." class="img-circle profile_img">
              </div>
              ...
              <div class="menu_section">
               ...
               edu
                <ul class="nav side-menu">
                  <li>
                  <a href="../prepago/principal.php"><i class="fa fa-home"></i> Home <span class="fa fa-home"></span></a>
                    
                  </li>
                  
                  <li>
                     <a><i class="fa fa-mobile"></i> Membresia <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                           <li class="dropdown-submenu">
                                <a class="test" tabindex="-1" href="#">Clientes<span class="fa fa-sort-amount-asc"></span></a>
                                    <ul class="nav child_menu">
                                          <li><a tabindex="-1" href="../prepago/registro_clientes.php">Registrar</a></li>
                                           <li><a tabindex="-1" href="../prepago/consultar_clientes.php">Consultar</a></li>
                           ...
                           <li class="dropdown-submenu">
                                <a class="test" tabindex="-1" href="#">Promociones<span class="fa fa-sort-amount-asc"></span></a>
                                    <ul class="nav child_menu"> 
                                          ...
                                          <li><a tabindex="-1" href="../catalogo/consultar_promociones.php">Consultar</a></li>
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a href="../seguridad/logout.php" data-toggle="tooltip" data-placement="top" title="Salir">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="../images/logo_arena.jpg" alt="">
                    <!--<?php echo $_SESSION['usuario'];?> -->
                    <span class=" fa fa-angle-down"></span>
                  </a>
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="javascript:;"> Perfil</a></li>
                    <li><a href="../seguridad/logout.php"><i class="fa fa-sign-out pull-right"></i> Salir</a></li>
                  </ul>
                </li>
              </ul>
            </nav>
